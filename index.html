      ...
      <div>
        ...
        <ul class="mb-6 flex flex-col gap-4">
          ...
          <li>
            <a
              href="#"
              @click.prevent="selected = (selected === 'Menu 01' ? '':'Menu 01')"
              class="menu-item group"
              :class=" (selected === 'Menu 01') ? 'menu-item-active' : 'menu-item-inactive'"
            >
              <svg
                :class="(selected === 'Menu 01') ? 'menu-item-icon-active' : 'menu-item-icon-inactive'"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                fill="none"
          ...
          <li>
            <a
              href="#"
              @click.prevent="selected = (selected === 'Menu 02' ? '':'Menu 02')"
              class="menu-item group"
              :class=" (selected === 'Menu 02') ? 'menu-item-active' : 'menu-item-inactive'"
            >
              <svg
                :class="(selected === 'Menu 02') ? 'menu-item-icon-active' : 'menu-item-icon-inactive'"
                width="24"
                height="24"
                viewBox="0 0 24 24"
                fill="none"
              ...
              <svg
                ...
                :class="[(selected === 'Menu 02') ? 'menu-item-arrow-active' : 'menu-item-arrow-inactive', sidebarToggle ? 'lg:hidden' : '' ]"
                width="20"
                height="20"
                viewBox="0 0 20 20"
                fill="none"
            ...
            <div
              ...
              :class="(selected === 'Menu 02') ? 'block' :'hidden'"
            >
              <ul
              ...
              >
                <li>
                  <a
                    ...
                    :class="page === 'Menu 02' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'"
                  >
                    List
                  </a>
                </li>
    ...
    >
      <div class="2xsm:gap-3 flex items-center gap-2">
        ...
        >
          ...
          <div
            x-show="dropdownOpen"
            class="shadow-theme-lg dark:bg-gray-dark absolute -right-[240px] mt-[17px] flex h-[470px] w-[350px] flex-col rounded-2xl border border-gray-200 bg-white p-3 sm:w-[361px] lg:right-0 dark:border-gray-800"
          >
            <div
      ...
      >
        ...
        >
          <span class="mr-3 h-11 w-11 overflow-hidden rounded-full">
            <img src="src/images/user/user-06.jpg" alt="User" />
          </span>

          <span class="text-theme-sm mr-1 block font-medium"> Sugeng Utomo </span>
      ...
      <tbody>
          ...
          <td class="px-5 py-4 sm:px-6" colspan="1">
            <div class="flex items-center gap-3">
              <div class="w-10 h-10 overflow-hidden rounded-full">
                <img src="src/images/user/user-01.jpg" alt="brand" />
              </div>
              <div>
                <span
        ...
        <tr class="border-b border-gray-100 dark:border-gray-800">
          <td class="px-5 py-4 sm:px-6" colspan="1">
            <div class="flex items-center gap-3">
              <div class="w-10 h-10 overflow-hidden rounded-full">
                <img src="src/images/user/user-02.jpg" alt="brand" />
              </div>
              <div>
                <span
                  class="block font-medium text-gray-800 text-theme-sm dark:text-white/90"
          ...
          <td class="px-5 py-4 sm:px-6">
            <p
              class="bg-warning-50 text-theme-xs text-warning-700 dark:bg-warning-500/15 dark:text-warning-400 inline-block rounded-full px-2 py-0.5 font-medium"
            >
              Pending
            </p>
          </td>
          <td class="px-5 py-4 sm:px-6">
            <p class="text-gray-500 text-theme-sm dark:text-gray-400">24.9K</p>
          </td>
        </tr>
        <tr class="border-b border-gray-100 dark:border-gray-800">
          <td class="px-5 py-4 sm:px-6" colspan="1">
            <div class="flex items-center gap-3">
              <div class="w-10 h-10 overflow-hidden rounded-full">
                <img src="src/images/user/user-03.jpg" alt="brand" />
              </div>
              <div>
                <span
                  class="block font-medium text-gray-800 text-theme-sm dark:text-white/90"
          ...
          <td class="px-5 py-4 sm:px-6">
            <p class="text-gray-500 text-theme-sm dark:text-gray-400">12.7K</p>
          </td>
        </tr>
        <tr class="border-b border-gray-100 dark:border-gray-800">
          <td class="px-5 py-4 sm:px-6" colspan="1">
            <div class="flex items-center gap-3">
              <div class="w-10 h-10 overflow-hidden rounded-full">
                <img src="src/images/user/user-04.jpg" alt="brand" />
              </div>
              <div>
                <span
                  class="block font-medium text-gray-800 text-theme-sm dark:text-white/90"
          ...
          <td class="px-5 py-4 sm:px-6">
            <p
              class="bg-error-50 text-theme-xs text-error-700 dark:bg-error-500/15 dark:text-error-500 inline-block rounded-full px-2 py-0.5 font-medium"
            >
              Cancel
            </p>
          </td>
        ...
        <tr class="border-b border-gray-100 dark:border-gray-800">
          <td class="px-5 py-4 sm:px-6" colspan="1">
            <div class="flex items-center gap-3">
              <div class="w-10 h-10 overflow-hidden rounded-full">
                <img src="src/images/user/user-05.jpg" alt="brand" />
              </div>
              <div>
                <span
                  class="block font-medium text-gray-800 text-theme-sm dark:text-white/90"
